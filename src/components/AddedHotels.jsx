...
const AddedHotels = () => {
  ...
  // functions to navigate to hotel details page
            ...
            <div className="w-full h-fit bg-gray-50 px-3 py-3 rounded-2xl shadow-md">
              ...
              <div className="mt-2">
                ...
                <p className="text-green-800 font-medium mt-2">
                  From <span className="font-semibold text-lg">₹3,200</span> /
                  night
                </p>
                <button
                  onClick={() => handleNavigate(item.id)}
                  className="w-[100%] btn-green  text-white py-2 cursor-pointer rounded-lg mt-3 hover:bg-green-800 transition"
                >
                  View details
                </button>
              </div>
