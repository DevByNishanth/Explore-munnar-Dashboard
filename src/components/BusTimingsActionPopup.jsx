  ...
  return (
    <>
      ...
      <section className="bg-white w-[40%] pb-4 px-6 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] rounded-lg z-60">
        ...
        <h1 className="text-xl font-medium m-auto w-[60%] text-center mt-2 text-gray-700">
          Are you sure want to delete this record?
        </h1>
        <div className="btn-container flex items-center gap-2 mt-4">
          <button
            onClick={onclose}
            className="bg-gray-300 rounded-lg w-[50%] py-2 cursor-pointer"
          >
            Cancel
          </button>
          <button
            onClick={handleDelete}
            className="bg-amber-900 text-white rounded-lg w-[50%] py-2 cursor-pointer"
          >
            Delete
          </button>
        </div>
